...
def k_parser():
	...
	parser.add_argument("--output", help="Output file, default: ./mintaka_predicted.csv if not specified")
	...
	parser.add_argument('--inference_task', default="text2text-generation", help="either text2text-generation or text-generation, the others are not suitable for inference")
	parser.add_argument('--model_name', default="bert-large-uncased", help="""choose in this list: bert-large-uncased, t5-small, t5-base, t5-large for text2text-generation
